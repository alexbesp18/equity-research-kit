"""macOS clean-open gate: prove an .xlsx opens in Excel WITHOUT the 'recover?' repair prompt.
...
def _classify_failure(returncode: int, out: str, err: str) -> str:
    ...
    text = raw.lower()
    if "-50" in text or "active workbook" in text or "connection invalid" in text:
